...
namespace Indd.Service.Commands.Document {
    ...
    /// </summary>
    public class ExportXML : Abstract,  Contracts.ICommand
    {
        /// <summary>
        /// Saves dynamic command 
        /// </summary>
        /// <param name="commandRequests"></param>
        public ExportXML(dynamic commandRequest) : base ((object)commandRequest){}
        ...
        public override bool execute()
        {
            try
            {
                ...
                this.document.Export(InDesignServer.idExportFormat.idXML, this.exportFilePath);
                
                document.Close();
            }
            catch (System.Exception ex)
            {
                throw new SystemException("Document.ExportXML failed: " + ex.Message);
            }
        ...
        {
            this.exportFilePath = (string)this.commandRequest.exportFolderPath + "\\" + this.uuid + "\\document_"+this.version+".xml";
