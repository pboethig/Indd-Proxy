...
namespace Indd.Service.Commands.Document {
    ...
    /// </summary>
    public class ExportIDML : Abstract,  Contracts.ICommand
    {
        /// <summary>
        /// Saves dynamic command 
        /// </summary>
        /// <param name="commandRequests"></param>
        public ExportIDML(dynamic commandRequest) : base ((object)commandRequest){}
        ...
        public override bool execute()
        {
            try
            {
                ...
                this.document.Export(InDesignServer.idExportFormat.idInDesignMarkup, this.exportFilePath);
                
                document.Close();
            }
            catch (System.Exception ex)
            {
                throw new SystemException("Document.ExportIDML failed: " + ex.Message);
            }
        ...
        {
            this.exportFilePath = (string)this.commandRequest.exportFolderPath + "\\" + this.uuid + "\\document_"+this.version+".idml";
